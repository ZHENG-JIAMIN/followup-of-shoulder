...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: wTSBbjdFii9t/css
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_mDkSz-0nMYUF"]]: true })}
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__uL8Hd)}
              >
                <div
                  className={classNames(
                    projectcss.all,
