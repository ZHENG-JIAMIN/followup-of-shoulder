...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: aVYX24fZHPln/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: kSMvAbxe7o9l/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__vycdS)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__lCCdu)}
              />
            </React.Fragment>
          ),
          value: args.children
